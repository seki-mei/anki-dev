...
3. open `user_files` and then `images`
4. copy your images there

alternatively, you can reach the path in your file explorer:
Windows
`%APPDATA%\Anki2\addons21\anianki\user_files\images`
MacOS
 `~/Library/Application Support/Anki2/addons21/anianki/user_files/images`
Linux
`~/.local/share/Anki2/addons21/anianki/user_files/images`
